...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Obtener persona por numero seguridad social: "+seguridadSocial.obtenerPersonaPorNumSS(maria.getNum_ss()));

        System.out.println("Obtener personas por rango Salarial: "+seguridadSocial.obtenerPersonasRangoSalarial(23000.00,45000.00));
